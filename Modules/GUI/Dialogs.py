...
class ErrorReportDialog(QDialog):
    def __init__(
        ...
        *,
        ...
        self.summary_label.setObjectName("ErrorSummary")
        self.summary_label.setWordWrap(True)
        self.summary_label.setTextInteractionFlags(Qt.TextInteractionFlag.TextSelectableByMouse)
        layout.addWidget(self.summary_label)

        details_label = QLabel("오류 상세 내용")
        details_label.setObjectName("DetailLabel")
        ...
        self.action_status.setObjectName("HelpText")
...
class UpdateHistoryDialog(QDialog):
    def __init__(self, parent=None, *, history_path: Path | None = None):
        ...
        self.setObjectName("UpdateHistoryDialog")
        self.resize(620, 520)

        layout = QVBoxLayout(self)
        layout.setContentsMargins(22, 20, 22, 20)
        layout.setSpacing(12)
        title = QLabel("업데이트 내역")
        title.setObjectName("DialogTitle")
        layout.addWidget(title)
        description = QLabel("버전별 주요 변경 사항과 개선 내용을 확인할 수 있습니다.")
        description.setObjectName("HelpText")
        layout.addWidget(description)
        self.history_view = QPlainTextEdit()
        self.history_view.setObjectName("DocumentView")
