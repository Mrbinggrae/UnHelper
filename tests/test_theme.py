...
class DarkThemeTests(unittest.TestCase):
    ...
    def test_palette_and_stylesheet_use_dark_layered_surfaces(self) -> None:
        ...
        self.assertIn('classification="양곡"', APP_STYLESHEET)
        self.assertIn("QLineEdit#TableSearchInput", APP_STYLESHEET)
        self.assertIn("QLabel#ArrivalDetailHeading", APP_STYLESHEET)
        self.assertIn("QLabel#ArrivalDetailList", APP_STYLESHEET)
        self.assertIn("QScrollArea#ArrivalScroll", APP_STYLESHEET)
        self.assertNotIn("QTableWidget#ArrivalDetailTable", APP_STYLESHEET)
